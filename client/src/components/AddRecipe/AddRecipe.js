                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        <div className="col-md-12">
                                            ...
                                            <textarea id="ingredients" style={{ borderColor: errors.name ? 'red' : 'inherit' }} className="textarea" placeholder="1 tomato, 8 arugula etc." type="text" name="ingredients" onBlur={onHandler}></textarea>
                                            {errors.name && <span className='errtxt'>{errors.name}</span>}
                                        </div>
                                        <div className="col-md-12">
                                            <label htmlFor="directions">Directions</label>
                                            <textarea id="directions"  style={{ borderColor: errors.name ? 'red' : 'inherit' }} className="textarea" placeholder="Directions Summary" type="text" name="directions" onBlur={onHandler}></textarea>
                                            {errors.name && <span className='errtxt'>{errors.name}</span>}
                                        </div>
                                        <div className="col-md-12">
